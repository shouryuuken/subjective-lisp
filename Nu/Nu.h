...
+ (NuBridgedFunction *) staticFunction:(void *)func name:(char *)n signature:(char *)signature;
 ...
 */
@interface NSNull(Nu) <NSFastEnumeration>
...
@property (nonatomic, assign) NSInteger needBytes;
@property (nonatomic, assign) SEL bytesHandler;
@property (nonatomic, retain) NSString *commandName;
@property (nonatomic, assign) uint16_t port;
@property (nonatomic, retain) NSMutableArray *outputLog;
@end
...
void prn(NSString *str);
id get_symbol_value_with_context(NSString *name, NSDictionary *context);
...
@interface Nu_fn_operator : NuOperator {}
@end

@interface PCRE : NuBlock
{
    pcre *_re;
}
...
@property (nonatomic, assign) int uploadDataIndex;
